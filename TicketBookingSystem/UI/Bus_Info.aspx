<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Admin.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Bus_Info.aspx.cs" Inherits="TicketBookingSystem.UI.Bus_Info" %>
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Bus_Name">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="Label1" runat="server" Text='<%#Eval("BusName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Bus_Type">
                        <ItemTemplate>
                            <asp:Label ID="Label21" runat="server" Text='<%#Eval("BusType")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Bus_No">
                        <ItemTemplate>
                            <asp:Label ID="Labelw21" runat="server" Text='<%#Eval("BusNo")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
