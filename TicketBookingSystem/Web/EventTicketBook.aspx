<%@ Page Title="" Language="C#" MasterPageFile="~/Web/IndexMaster.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="EventTicketBook.aspx.cs" Inherits="TicketBookingSystem.Web.EventTicketBook" %>
        ...
        <div class="col-8 p-2">
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <span>Ticket Avaiilable</span>
                    <asp:TextBox ID="txtSeatAvailable" class="form-control" placeholder="Ticket Available" ReadOnly="True" runat="server"></asp:TextBox>
                </div>
                <div class="col-12 col-lg-6">
