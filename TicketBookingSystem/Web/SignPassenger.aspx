...
<head runat="server">
    <title>Signup Passenger | My Tickets</title>
    <meta charset="utf-8" />
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <div class="row">
                                    ...
                                    <div class="col-3"></div>
                                    <div class="col-6 p-2">
                                        <asp:Button ID="btnSign" OnClick="btnSign_OnClick" class="btn btn-success wd-100" runat="server" Text="Sign up" />
                                    </div>
                                    <div class="col-3"></div>
                    ...
                    <asp:View ID="View3" runat="server">
                        <div class="row">
                            ...
                            <div class="col-3"></div>
                            <div class="col-6 p-2">
                                <asp:Button ID="btnConfirm" OnClick="btnConfirm_OnClick" class="btn btn-primary wd-100" runat="server" Text="Confirm Code" />
                            </div>
                            <div class="col-3"></div>
                        </div>
                    </asp:View>
